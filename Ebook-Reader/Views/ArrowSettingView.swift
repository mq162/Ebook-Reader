...
protocol ArrowSettingViewDelegate: AnyObject {
    func didClickArrowSettingView(_ view: ArrowSettingView)
}

class ArrowSettingView: UIView {
    ...
    weak var delegate: ArrowSettingViewDelegate?
    ...
    func addDdetailLabelIfNeeded() {
        ...
        detailLabel?.textColor = UIColor(hexStr: "BABABA")
    ...
    func setupSubviews() {
        ...
        arrowView.image = UIImage(named: "arrow_grey_right")?.template
        arrowView.tintColor = UIColor(hexStr:"BABABA")
